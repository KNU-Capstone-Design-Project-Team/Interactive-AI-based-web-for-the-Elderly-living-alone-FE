...
return(
    ...
    <SelectWrapper>
                <SelectButton onClick={() => handleSelect('senior')}
                    isSelected={selectedType === 'senior'}>
                    <Icon src={Senior} alt="OldMan" />
                    <SBtext   isSelected={selectedType === 'senior'}>
                    행복어르신</SBtext>
                </SelectButton>
                <SelectButton onClick={() => handleSelect('supervisor')}
                isSelected={selectedType === 'supervisor'}> 
                <Icon src={Supervisor} alt="Supervisor" />
                <SBtext   isSelected={selectedType === 'supervisor'}>
                보호자</SBtext>
                </SelectButton>
            </SelectWrapper>
   
    <NextButton onClick = {handleNavigation}>
        다음으로
        </NextButton>
        </Wrapper>
)
